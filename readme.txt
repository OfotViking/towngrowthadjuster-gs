...
//////////////////////////////////////////////////////////////////////////
 ...
 - Find the correct cargo IDs of the cargoes on the landscape.
 - Set the cargo promilles of the cargoes to the values you want.
 - Note: You do not have to set promilles to zero for cargoes that are not used
	from version 72 onwards. This means one set of settings can work for multiple
	climates!
...
Towns in the Rainforest require water. Unfortunately GSTile::IsDesertTile appears to be broken.
 ...
 - News messages are untranslatable
 
News messages cannot be translated. This is deliberate as GSText doesn't have sufficient support.
